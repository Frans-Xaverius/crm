...
class WhatsappApiController extends Controller
{
    ...
    public function getQontakData($request)
    {
        ...
        $rawData = QontakDatas::whereIn('channel', ['wa', 'wa_cloud'])
            ->where('_updated_at', date('Y-m-d', strtotime($request->from_date)))
            ->get();

        $yesterdayRawData = QontakDatas::where('channel', ['wa', 'wa_cloud'])
    ...
    public function getGraphData()
    {
        ...
        // dayly
        $dailyWa = QontakDatas::whereIn('channel', ['wa', 'wa_cloud'])
        ...
        $weekly = [];
        $weeklyData = QontakDatas::whereIn('channel', ['wa', 'wa_cloud'])->whereYear('_updated_at', date('Y'))->whereMonth('_updated_at', date('m'))->orderBy('_updated_at', 'asc')->get();
        $read = 0;
        $unread = 0;
        ...
        $rawMonthlyWa = QontakDatas::whereIn('channel', ['wa', 'wa_cloud'])
            ->whereYear('_updated_at', date('Y'))
        ...
        // yearly
        $rawYearlyWa = QontakDatas::whereIn('channel', ['wa', 'wa_cloud'])
            ->orderBy('_updated_at', 'asc')
            ->get();

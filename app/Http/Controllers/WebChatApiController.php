...
class WebChatApiController extends Controller
{
    ...
    {
        $rawData = QontakDatas::where('channel', 'web_chat')
            ->where('_updated_at', date('Y-m-d', strtotime($request->from_date)))
            ->get();

        $yesterdayRawData = QontakDatas::where('channel', 'web_chat')
    ...
    public function getGraphData()
    {
        ...
        // dayly
        $dailyWa = QontakDatas::where('channel', 'web_chat')
        ...
        $weekly = [];
        $weeklyData = QontakDatas::where('channel','web_chat')->whereYear('_updated_at', date('Y'))->whereMonth('_updated_at', date('m'))->orderBy('_updated_at', 'asc')->get();
        $read = 0;
        $unread = 0;
        ...
        // monthly
        $rawMonthlyWa = QontakDatas::where('channel', 'web_chat')
            ->whereYear('_updated_at', date('Y'))
            ->orderBy('_updated_at', 'asc')
            ->get();
        ...
        // yearly
        $rawYearlyWa = QontakDatas::where('channel', 'web_chat')
            ->orderBy('_updated_at', 'asc')
            ->get();

    ...
    <script>
        function chart(selector, data = []) {
            am5.ready(function() {
                ...
                createSeries("Facebook", "facebook", "#0D8CF2");
                createSeries("Instagram", "instagram", "#0D8CF2");
                createSeries("WA Business", "whatsapp", "#37E35A");
                createSeries("Call Center", "callcenter", "#ffc0cb");
                createSeries("Web Chat", "web_chat", "#ffc0cb");
                ...
                var exporting = am5plugins_exporting.Exporting.new(root, {
                    ...
                    dataSource: data,
                    numericFields: ["facebook", "instagram", "whatsapp", 'callcenter', 'web_chat'],
                    numberFormat: "#,###",
                    // dateFields: ["date"],
                    ...
                    dataFieldsOrder: ["facebook", "instagram", "whatsapp", 'callcenter', 'web_chat'],

    ...
    <script>
        function chart(selector, data = []) {
            am5.ready(function() {
                ...
                // createSeries("Followers", "followers", "#add8e6");
                createSeries("Likes", "likes", "#ffc0cb");
                createSeries("Comments", "comments", "#FFCD9F");
                ...
                var exporting = am5plugins_exporting.Exporting.new(root, {
                    ...
                    dataSource: data,
                    // numericFields: ["followers", "likes", "comments"],
                    numericFields: ["likes", "comments"],
                    numberFormat: "#,###",
                    // dateFields: ["date"],
                    ...
                    // dataFieldsOrder: ["followers", "likes", "comments"],
                    dataFieldsOrder: ["likes", "comments"],
                    filePrefix: "Facebook"
                });

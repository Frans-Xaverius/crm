        ...
        <ul class="navbar-nav text-blue">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="#navbar-examples" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="navbar-examples">
                    ...
                    <span class="nav-link-text" style="color: #f4645f;">{{ __('Application') }}</span>
                </a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('icons') }}">
                    <i class="ni ni-vector text-blue"></i> {{ __('Customer Monitoring') }}
                </a>
            </li>
            <li class="nav-item">
            ...
            <div style="position: absolute; top: 550px;">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('icons') }}">
                        <i class="ni ni-bulb-61 text-blue"></i> {{ __('Help') }}
                    </a>
                </li>
            </div>
        </ul>
...
<div class="container-fluid">
    <!-- Brand -->
    <a class="h4 mb-0 text-blue text-uppercase d-none d-lg-inline-block" href="{{ route('home') }}">Dashboard</a>
    <!-- Form -->

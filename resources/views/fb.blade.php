        ...
        <div class="row">
            <div class="col-xl-8 mb-2 mb-xl-0">
                <div class="card bg-gradient-white shadow card-tab">
                    ...
                    <div class="card-body">
                        <!-- Chart -->
                        <div class="chart">
                            @include('layouts.chart.dashboard-line-fb')
                        </div>
                    </div>
                </div>
                @php
            ...
            <div class="col-xl-4">
                <div class="card shadow">
                    <div class="card-body">
                        <h2 class="text-default mb-0 text-center">Total Likes</h2>
                        <hr class="my-3">
        ...
        function loadData(date = null) {
            $.ajax({
                ...
                success: function(r) {
                    ...
                    $('#dmy-d-data').text(d.likes);
                    $('#dmy-m-data').text(m.likes);
                    $('#dmy-y-data').text(y.likes);

                    $('#dmy-d-percent').text(get_percentage(d.likes, (d.likes) - (pd.likes)) + "%");
                    $('#dmy-m-percent').text(get_percentage(m.likes, (m.likes) - (pm.likes)) + "%");

                    if (py.length) {
                        py = py[0];
                        $('#dmy-y-percent').text(get_percentage(y.likes, (y.likes) - (py.likes)) + "%");
                    }
                }
            });
        }

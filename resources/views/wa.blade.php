            ...
            <div class="col-xl-8 mb-2 mb-xl-0 ">
                <div class="card bg-gradient-white shadow card-tab">
                    ...
                    <div class="card-body">
                        <!-- Chart -->
                        <div class="chart">
                            @include('layouts.chart.dashboard-line-wa')
                        </div>
                    </div>
                </div>
                @php
                        ...
                        @foreach ($dmy as $k => $v)
                            <div class="dmy" id="dmy-{{ $v }}" {!! $k != 0 ? 'style="display: none"' : '' !!}>
                                ...
                                <p class="mt-3 mb-0 text-muted text-sm text-center">
                                    <span id="dmy-{{ $v }}-text" class="text-success mr-2 font-weight-bold" style="font-size: large">
                                        <i id="dmy-{{ $v }}-arrow" class="fas fa-arrow-up"></i> <span id="dmy-{{ $v }}-percent">0%</span>
                                    </span>
